...
const ModalSlider = ({ modal, handleModal }) => {
  const form = useRef();
  ...
  return (
    <>
      ...
      {push && (
        <div className="absolute top-20 duration-500 transition-all w-[160px] bg-[#66BB6A] left-1/2 -translate-x-1/2 px-12 py-8 flex flex-col justify-center items-center gap-y-2 rounded-lg">
