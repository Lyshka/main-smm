...
const Slider = () => {
  ...
  return (
    ...
    >
      <div className="relative min-w-max h-screen duration-500 text-black flex justify-start items-center">
        <img
          src="https://smm-ibis.by/wp-content/uploads/2023/08/Property-11.png.png"
        ...
        <div className="flex w-full justify-between items-center absolute px-[238px]">
          <div onClick={() => a()} className="w-8 h-8 cursor-pointer rounded-full flex justify-center items-center bg-black/50">
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
          ...
          <div onClick={() =>b()} className="w-8 h-8 rounded-full cursor-pointer flex justify-center items-center bg-black/50">
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
